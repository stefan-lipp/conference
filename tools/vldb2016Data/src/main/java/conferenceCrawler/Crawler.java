...
public class Crawler {
	...
	static HashSet<Paper> papers = new HashSet<>();
	static HashSet<Event> events = new HashSet<>();
	static HashSet<Session> sessions = new HashSet<>();
	static Hashtable<String, UUID> institutes = new Hashtable<>();
	static HashSet<String> locations = new HashSet<>();
	static HashSet<String> tags = new HashSet<>();
	static Hashtable<String,Integer> tracks = new Hashtable<>();
	...
	public static void main(String[] args) throws IOException, ParseException, ClassNotFoundException, SQLException {
		...
		uuids = Files.lines(Paths.get("uuids.csv")).collect(Collectors.toList());
	...
	static class Person {
		UUID id = UUID.fromString(uuids.get(uuidcount++));
		String name;
		String email;
		String institute;
		...
		public Person(String parsestring) {
			...
			if (!institutes.contains(institute)) {
				institutes.put(institute, UUID.fromString(uuids.get(uuidcount++)));
			}
